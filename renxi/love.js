(function (window) {
  ...
  Footer.prototype = {
    draw: function () {
      ...
      ctx.save();
      ctx.strokeStyle = "rgba(248, 197, 210, 1)";
  ...
  Branch.prototype = {
    ...
    draw: function (p) {
      ...
      ctx.save();
      ctx.beginPath();
      ctx.fillStyle = "rgba(253, 147, 174, 1)";
      ctx.shadowColor = "rgba(253, 147, 174, 1)";
      ctx.shadowBlur = 2;
      ctx.moveTo(p.x, p.y);
...
// প্রতি ১ সেকেন্ডে clock আপডেট হবে
setInterval(updateClock, 1000);

// পেজ লোড হবার সাথে সাথে কল কর
updateClock();
